...
import com.kenny.craftix.client.entity.player.PlayerInput;
...
public class CraftixOld
{
	...
	private GuiOptionsMenu guiOptionsMenu = new GuiOptionsMenu();
	...
	public static void updateLoadingSplashDisplay()
	{
		...
		if(GuiRenderManager.renderLoadingSplash)
		{
			...
			guiRenderer.render(guiLoading.guisLoadingBackground);
			guiLoading.updateButtons();
