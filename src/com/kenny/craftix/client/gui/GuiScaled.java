...
public class GuiScaled implements IGuiScaleManager
{
	...
	public void initGuiScaleAuto() 
	{
		...
		GuiAbstractButton.x = this.buttonX = 0.26f;
		GuiAbstractButton.y = this.buttonY = 0.08f;
	}
	...
	public void initGuiScaleMedium() 
	{
		...
		GuiAbstractButton.x = this.buttonX = 0.23f;
		GuiAbstractButton.y = this.buttonY = 0.06f;
	}
	...
	public void initGuiScaleSmall() 
	{
		...
		GuiAbstractButton.x = this.buttonX = 0.20f;
		GuiAbstractButton.y = this.buttonY = 0.05f;
	}
