...
public class ParticleInit 
{
	...
	{
		this.t_Smoke = new ParticleTexture(this.loader.loadFile("particles/smoke"), 8, false);
		this.t_Fire = new ParticleTexture(this.loader.loadFile("particles/fire"), 8, true);
		this.t_Star = new ParticleTexture(this.loader.loadFile("particles/star"), 1, false);
		this.t_Cosmic = new ParticleTexture(this.loader.loadFile("particles/cosmic"), 4, false);
	}
