...
public class GuiTextWorld 
{
	 ...
	 */
	public GuiTextWorld(String text, float fontSize, FontType font, Vector2f position, float maxLineLength,
			boolean centered) 
	{
	...
	public void remove() 
	{
		TextMaster.removeTextPause(this);
	}
