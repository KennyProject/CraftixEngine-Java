...
public class SkyboxSunMoonRenderer 
{
	...
	public SkyboxSunMoonRenderer(Craftix craftixIn, Loader loader, Matrix4f projectionMatrix)
	{
		this.cube = loader.loadToVAO(VERTICES, 3);
		this.skyboxSunMoonTextures = loader.loadCubeMapNew(SKYBOX_SUN_MOON);
