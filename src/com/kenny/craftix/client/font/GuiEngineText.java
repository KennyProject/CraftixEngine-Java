...
public class GuiEngineText 
{
	 ...
	 */
	public GuiEngineText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength,
			boolean centered) 
	{
		...
		TextMaster.loadTextMenu(this);
	}
	
	public GuiEngineText(int id, float x, float y, boolean centered, boolean show, String textIn) 
	{
		this.id = id;
		this.textString = textIn;
		this.fontSize = 1.6f;
		this.font = this.setDefalutFont();
	...
	public void hide()
	{
		if(isRender)
		{
			TextMaster.removeTextMenu(this);
			this.isRender = false;
		}
	}
	...
	public FontType setDefalutFont()
	{
		FontType fontCandara = new FontType(this.loader.loadFontAtlas("candara"), "candara");
			return fontCandara;
	}
