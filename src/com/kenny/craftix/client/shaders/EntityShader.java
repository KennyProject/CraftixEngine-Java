...
public class EntityShader extends ShaderProgram
{
	private static final String VERTEX_FILE_LOCATION = 
			ResourceLocation.SHADER_FOLDER + "vertexShader" + VERTEX;
	private static final String FRAGMENT_FILE_LOCATION = 
			ResourceLocation.SHADER_FOLDER + "fragmentShader" + FRAGMENT;
	...
	private String shaderName = "[EntityShader]";
	...
	{
		this.location_trasformationMatrix = getUniformLocation("trasformationMatrix", shaderName);
