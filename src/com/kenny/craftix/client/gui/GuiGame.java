...
public class GuiGame extends GuiScreen implements IGui, IGuiUpdateble
{
	...
	{	
		this.gui_logo = drawGui("guis/game/logo_engine", this.cx.cxLoader, 0.80f, 0.75f, 0.15f, 0.25f);
		this.gui_healthBorder = drawGui("guis/game/health_empty", this.cx.cxLoader, -0.75f, -0.9f, 0.20f, 0.35f);
		this.gui_health_bar_back = drawGui("guis/game/health_bar_back", this.cx.cxLoader, -0.71f, -0.9f, 0.204f, 0.35f);
		this.gui_health_bar = drawGui("guis/game/health_bar", this.cx.cxLoader, -0.71f, -0.9f, 0.204f, 0.35f);
	}
	...
	public void drawGuiButtons()
	{
					...
					new Vector2f(-0.06f, 0.85f), -0.20f - x, 0.03f - y) 
		{
			...
			public void onClick(IButton button) 
			{
				...
				EntityCamera camera = new EntityCamera(cx.getWorld().getPlayer());
				...
				new Vector2f(0.18f, 0.85f), -0.20f - x, 0.03f - y) 
		{
			...
			public void onClick(IButton button) 
			{
				gamemode = new GameMode(cx.getWorld().getPlayer(), 0);
			}
			public void isVisible(boolean visibleIn) {}
				...
				new Vector2f(0.30f, 0.85f), -0.20f - x, 0.03f - y) 
		{
			...
			public void onClick(IButton button) 
			{
				gamemode = new GameMode(cx.getWorld().getPlayer(), 1);
			}
			public void isVisible(boolean visibleIn) {}
